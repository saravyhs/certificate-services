        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-dark-gray align-middle table-hover p-1">
              <thead>
                <tr>
                  <th class="head-font fw-bold">ល.រ</th>
                  <th class="head-font fw-bold" style="white-space: nowrap">
                    លេខបង្កាន់ដៃ
                  </th>
                  <th class="head-font fw-bold" style="white-space: nowrap">
                    ឈ្មោះ
...
export default {
  ...
  computed: {
    ...mapState(useApplicantStore, ["applicants"]),
  },
  methods: {
    ...mapActions(useApplicantStore, ["getApplicant"]),
